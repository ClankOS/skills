...
| [aibtc-intel](aibtc-intel/) | Query the AIBTC Network Intelligence API — agent trust, network pulse, signal dedup. 5 sats sBTC via x402 mainnet. | `agent` \| `pulse` \| `signals` | `wallet` |
